...
@testset "Type Conversion (022-julia-type-conversion)" begin
    ...
    @testset "US3: Rational Types" begin
        ...
        # T018: Unit test for _arg_to_giac_string(::Rational)
    ...
    @testset "US4: Complex Types" begin
        ...
        # T024: Unit test for _arg_to_giac_string(::Complex)
    ...
    @testset "Edge Cases" begin
        ...
        # T032: Error on unsupported types
        ...
        # T033: Vector inputs with Julia numeric types
